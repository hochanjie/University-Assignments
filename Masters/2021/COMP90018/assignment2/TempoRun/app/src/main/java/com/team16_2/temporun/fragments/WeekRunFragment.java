...
public class WeekRunFragment extends Fragment {

    private View view;
    private ArrayList<RunDetail> weekRun;
    private final static Integer numDays = 7 - 1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_week_run, container, false);
        ...
        weekRun = getArguments().getParcelableArrayList("weekRun");
        replaceFragment(new TimeFragment());
//        replaceFragment(new DistanceFragment());
    ...
    private void replaceFragment(Fragment fragment) {
        ...
        bundle.putParcelableArrayList("runDetails", weekRun);
        bundle.putInt("numDays", numDays);
        fragment.setArguments(bundle);

        FragmentManager fragmentManager = getParentFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.replace(R.id.week_frame_layout, fragment);
