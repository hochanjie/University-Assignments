...
public class TimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lineChart = view.findViewById(R.id.time_line_chart);
...
//        ArrayList for x-axis
        ...
        for (RunDetail rd : runDetails) {
            ...
            timeDict.put(curDate, (int) (rd.getStartTime().until( rd.getEndTime(), ChronoUnit.MINUTES )));
        }
        ...
        LineDataSet lineDataSet = new LineDataSet(dataSet, "Time");
